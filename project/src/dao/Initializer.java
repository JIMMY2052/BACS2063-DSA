...
public class Initializer {
    ...
    public Initializer() {
        ...
        Donation d1 = new Donation(donors.getEntry(0), "F", "EV002", new Date(2024 - 1900, 6, 1));
        Donation d2 = new Donation(donors.getEntry(1), "F", "EV002", new Date(2024 - 1900, 6, 5));
        ...
        Donation d13 = new Donation(donors.getEntry(12), "C", "EV004");
        Donation d14 = new Donation(donors.getEntry(13), "F", "EV002");
        Donation d15 = new Donation(donors.getEntry(2), "F", "EV003");
        Donation d16 = new Donation(donors.getEntry(1), "C", "EV005");
        Donation d17 = new Donation(donors.getEntry(0), "F", "EV003");
        ...
        donors.getEntry(5).addDonation(d6);
        donors.getEntry(6).addDonation(d7);
        donors.getEntry(7).addDonation(d8);
        donors.getEntry(8).addDonation(d9);
        donors.getEntry(9).addDonation(d10);
        donors.getEntry(10).addDonation(d11);
        donors.getEntry(11).addDonation(d12);
        donors.getEntry(12).addDonation(d13);
        donors.getEntry(13).addDonation(d14);
        donors.getEntry(2).addDonation(d15);
        donors.getEntry(1).addDonation(d16);
        donors.getEntry(0).addDonation(d17);

        d1.addDonatedItem(new DonatedItem("SPAGHETTI", 2000, "KG"));
        ...
        d6.addDonatedItem(new DonatedItem("MILO", 88, "KG"));
        d6.addDonatedItem(new DonatedItem("ClOTHES", 8, "UNIT"));
        d7.addDonatedItem(new DonatedItem("APPLE", 8, "UNIT"));
        d8.addDonatedItem(new DonatedItem("FLOUR", 50, "KG"));
        d8.addDonatedItem(new DonatedItem("SUGAR", 20, "KG"));
        d9.addDonatedItem(new DonatedItem("CASH", 5000, "RM"));
        d10.addDonatedItem(new DonatedItem("RICE", 100, "KG"));
        d11.addDonatedItem(new DonatedItem("CASH", 1000, "RM"));
        d12.addDonatedItem(new DonatedItem("POTATOES", 500, "KG"));
        d13.addDonatedItem(new DonatedItem("CASH", 750, "RM"));
        d14.addDonatedItem(new DonatedItem("MILO", 40, "KG"));
        d15.addDonatedItem(new DonatedItem("CLOTHES", 20, "UNIT"));
        d16.addDonatedItem(new DonatedItem("CASH", 1200, "RM"));
        d17.addDonatedItem(new DonatedItem("OIL", 25, "L"));
        donations.add(d1);
        donations.add(d2);
        donations.add(d3);
        donations.add(d4);
        ...
        // Create and add DonationDistribution objects
        DonationDistribution distribution1 = new DonationDistribution(d1, "123 Main St", doneeList.getEntry(0));
        DonationDistribution distribution2 = new DonationDistribution(d2, "456 Elm St", doneeList.getEntry(1));
        DonationDistribution distribution3 = new DonationDistribution(d3, "789 Pine St", doneeList.getEntry(2));
        DonationDistribution distribution4 = new DonationDistribution(d4, "101 Maple St", doneeList.getEntry(3));
        DonationDistribution distribution5 = new DonationDistribution(d5, "202 Oak St", doneeList.getEntry(4));
